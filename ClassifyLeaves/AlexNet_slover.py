...
def Resnet_mosdels(num_classes, pre_train=True):
    resnet_model = models.resnet18(pretrained=pre_train)
    num_in = resnet_model.fc.in_features
    resnet_model.fc = nn.Sequential(nn.Linear(num_in, num_classes))
    return resnet_model
